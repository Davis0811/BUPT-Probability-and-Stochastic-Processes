...
% 定义 Solution 命令并换行
\newcommand{\solution}{
    \subparagraph{Solution}~{}\par
}

% 定义 Prove 命令并换行
\newcommand{\prove}{
    \subparagraph{Prove}~{}\par
}
...
\include{chapters/Chapter_0/Chapter_0.tex}

% Chapter_1 Events and Their Probabilities
\include{chapters/Chapter_1/Chapter_1.tex}

% Chapter_2 Random Variable
\include{chapters/Chapter_2/Chapter_2.tex}
...
\include{chapters/Chapter_7/Chapter_7.tex}

% Chapter_8 Independent-Increment Processes
\include{chapters/Chapter_8/Chapter_8.tex}
